...
namespace Pet_Store
{
    public partial class GraphWebForm : System.Web.UI.Page
    {
        ...
        private void OnRenderGraph(ZedGraph.Web.ZedGraphWeb z, System.Drawing.Graphics g, ZedGraph.MasterPane masterPane)
        {
            ...
            DataSet ds = (DataSet)Cache["ProduseCache"];
                    ...
                    case "Pie":
                        {
                            ...
                            foreach (DataRow r in ds.Tables[0].Rows)
                            {
                                PieItem segment1 = myPane.AddPieSlice((double)r[4], colors[(i++) % colors.Length], Color.White, 45f, (i % 2 == 0) ? 0.2 : 0, r[1].ToString());
                            }
                            break;
                        }
                }
